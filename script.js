...
(function () {
  ...
  const WHATSAPP_MESSAGE = encodeURIComponent(
    "Olá! Vim pelo site da WK Studio e gostaria de saber mais sobre as soluções digitais oferecidas. Poderia me ajudar?",
  );
  ...
  function assignWhatsapp() {
    ...
    planoCTAs.forEach(function (btn) {
      const planName =
        btn.closest(".plano-card")?.querySelector(".plano-nome")?.textContent ||
        "";
      ...
      btn.setAttribute(
        "href",
        `https://wa.me/${WHATSAPP_NUMBER}?text=${planMsg}`,
      );
